...
class PostURLTests(TestCase):
    ...
    def test_guest_url_code_200(self):
        """Вид страниц не авторизованного пользователя."""
    ...
    def test_uthorized_user_url_code_200(self):
        """Вид страниц авторизованным пользователем."""
    ...
    def test_response_404(self):
        """Запрос к несущетсвующей странице возвращает ошибку."""
        response = self.guest_client.get("/nonexistpost/")
