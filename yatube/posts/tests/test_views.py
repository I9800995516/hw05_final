...
from posts.tests.utconcom import check_comment, check_context
...
class PostPagesTests(TestCase):
    ...
    def test_post_index_group_profile_page_show_correct_context(self):
        """Проверка сontext на страницах index, group_list, profile."""
        cache.clear()
...
class PaginatorViewTest(TestCase):
    ...
    def test_second_page_contains_three_records(self):
        ...
        for page in self.pages_with_pagination:
            ...
            second_page = Post.objects.count() % PER_PAGE
